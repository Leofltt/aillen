...
/// Hoover-style synthesizer module.
pub mod hoover;
/// Hoover voice logic.
pub mod voice;

/// Patch parameters specifying a preset configuration for the versatile Rave/Bass `SynthHoover`.
#[derive(Clone, Copy, Debug, PartialEq)]
pub struct SynthHooverPatch {
...
impl Default for SynthHooverPatch {
    fn default() -> Self {
        Self {
